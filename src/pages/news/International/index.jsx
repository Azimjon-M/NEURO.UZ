...
export default function NewsIntl() {
    ...
    const UI = {
        uz: {
            ...
            desc: 'Dunyo bo‘ylab so‘nggi yangiliklar, rasmiy bayonotlar va global voqealar bilan tanishing.',
            empty: 'Hozircha xalqaro yangiliklar topilmadi.',
        },
        ru: {
            title: 'Международные новости',
            desc: 'Будьте в курсе последних мировых новостей, официальных заявлений и глобальных событий.',
            empty: 'Пока нет международных новостей.',
        },
        en: {
            title: 'International News',
            desc: 'Stay informed with the latest global headlines, official statements, and world events.',
            empty: 'No international news available yet.',
        },
    };
    ...
    const getData = async () => {
        try {
            const res = await ApiResult.getWorld();
            setRaw(res?.results);
        } catch {
            setRaw([]);
        }
