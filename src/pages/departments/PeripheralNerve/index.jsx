...
const UI_T = {
    uz: {
        ...
        desc: 'Periferik asab tizimi shikastlanishlari, nerv kompressiya sindromlari va ularning oqibatlarini jarrohlik yo‘li bilan davolash hamda bemorlarni reabilitatsiya qilish bilan shug‘ullanuvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Отделение хирургии периферических нервов и реабилитации',
        desc: 'Список специалистов, занимающихся хирургическим лечением повреждений периферической нервной системы, синдромов сдавления нервов и реабилитацией пациентов.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Peripheral Nerve Surgery and Rehabilitation Department',
        desc: 'List of specialists in surgical treatment of peripheral nerve injuries, compression syndromes, and patient rehabilitation.',
        empty: 'No data yet.',
    },
};
...
export default function DeptPeripheralNerve() {
    ...
    const getData = useCallback(async () => {
        try {
            const res =
                await ApiResult.getPeriferikAsabJarrohligiReabilitatsiya(); // DRF paginated object bo‘lishi mumkin
