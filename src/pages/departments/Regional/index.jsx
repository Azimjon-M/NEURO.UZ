...
const UI_T = {
    uz: {
        ...
        desc: 'Respublika hududlarida neyroxirurgik xizmatlarni rivojlantirish, mahalliy markazlar bilan hamkorlikda tashxis va davolash jarayonlarini olib boruvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Нейрохирургия в регионах',
        desc: 'Список специалистов, развивающих нейрохирургическую службу в регионах и сотрудничающих с местными медицинскими центрами для диагностики и лечения.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Neurosurgery in Regions',
        desc: 'List of specialists developing neurosurgical services across regions and collaborating with local centers for diagnosis and treatment.',
        empty: 'No data yet.',
    },
};
...
export default function Regional() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getHududlardaNeyroxirurgiya(); // DRF paginated object bo‘lishi mumkin
