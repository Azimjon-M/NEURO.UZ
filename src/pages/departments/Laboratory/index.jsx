...
const UI_T = {
    uz: {
        title: 'Laboratoriya',
        desc: 'Neyroxirurgik tashxis va davolash jarayonlari uchun zarur bo‘lgan klinik, biokimyoviy va mikrobiologik tahlillarni amalga oshiruvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Лаборатория',
        desc: 'Список специалистов, выполняющих клинические, биохимические и микробиологические анализы, необходимые для нейрохирургической диагностики и лечения.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Laboratory',
        desc: 'List of specialists performing clinical, biochemical, and microbiological tests essential for neurosurgical diagnosis and treatment.',
        empty: 'No data yet.',
    },
};
...
export default function DeptLaboratory() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getLaboratoriya(); // DRF paginated object bo‘lishi mumkin
