...
const UI_T = {
    uz: {
        ...
        desc: 'Bemorlarni dastlabki qabul qilish, maslahat berish, ambulator kuzatuv va davolash bilan shug‘ullanuvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Консультативно-поликлиническое отделение',
        desc: 'Список специалистов, осуществляющих первичный приём, консультации и амбулаторное наблюдение пациентов.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Consultative and Polyclinic Department',
        desc: 'List of specialists providing primary reception, consultations, and outpatient follow-up care.',
        empty: 'No data yet.',
    },
};
...
export default function DeptPolyclinic() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getKonsultativPoliklinika(); // DRF paginated object bo‘lishi mumkin
