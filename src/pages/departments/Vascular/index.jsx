...
const UI_T = {
    uz: {
        ...
        desc: 'Bosh miya qon tomirlari kasalliklari — anevrizma, arteriovenoz malformatsiya (AVM), insult va boshqa serebrovaskulyar patologiyalarni tashxislash hamda jarrohlik yo‘li bilan davolash bilan shug‘ullanuvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Отделение сосудистой нейрохирургии',
        desc: 'Список специалистов по диагностике и хирургическому лечению аневризм, артериовенозных мальформаций (АВМ), инсультов и других сосудистых патологий головного мозга.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Vascular Neurosurgery Department',
        desc: 'List of specialists in diagnosis and surgical treatment of cerebral vascular diseases — aneurysms, AVMs, strokes, and other cerebrovascular disorders.',
        empty: 'No data yet.',
    },
};
...
export default function DeptVascular() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getQonTomirNeyroxirurgiyasi(); // DRF paginated object bo‘lishi mumkin
