...
const UI_T = {
    uz: {
        ...
        desc: 'Og‘ir ahvoldagi neyrobemorlarni 24/7 kuzatuv va davolash: sun’iy nafas oldirish, monitoring, operatsiyadan keyingi intensiv parvarish va neyroreanimatsiya.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Реанимация и интенсивная терапия',
        desc: 'Круглосуточное наблюдение и лечение тяжёлых нейропациентов: ИВЛ, мониторинг, послеоперационный уход и нейрореанимация.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'ICU & Intensive Care Department',
        desc: '24/7 care for critically ill neuro-patients: mechanical ventilation, continuous monitoring, postoperative intensive care, and neurocritical care.',
        empty: 'No data yet.',
    },
};
...
export default function DeptICU() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getReanimatsiyaIntensivTerapiya(); // DRF paginated object bo‘lishi mumkin
