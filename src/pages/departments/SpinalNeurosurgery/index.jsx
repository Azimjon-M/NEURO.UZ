...
const UI_T = {
    uz: {
        ...
        desc: "Orqa miyya va umurtqa pog'onasi kasalliklari bo‘yicha diagnostika hamda jarrohlik amaliyotlarini olib boruvchi mutaxassislar ro‘yxati.",
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Отделение спинальной нейрохирургии',
        desc: 'Список специалистов по диагностике и хирургическому лечению заболеваний спинного мозга и позвоночника.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Spinal Neurosurgery Department',
        desc: 'List of specialists in diagnosis and surgical treatment of spinal cord and vertebral conditions.',
        empty: 'No data yet.',
    },
};
...
export default function DepSpinalNeurosurgery() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getOrqaMiyyaNeyroxirurgiyasi(); // DRF paginated object bo‘lishi mumkin
