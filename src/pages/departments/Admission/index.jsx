...
const UI_T = {
    uz: {
        title: "Qabul bo'limi",
        desc: 'Markazga murojaat qilgan bemorlarni birlamchi ko‘rikdan o‘tkazish, zarur bo‘limlarga yo‘naltirish va dastlabki tibbiy yordam ko‘rsatish bilan shug‘ullanuvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Приёмное отделение',
        desc: 'Список специалистов, осуществляющих первичный осмотр пациентов, направление их по отделениям и оказание неотложной медицинской помощи.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Admission Department',
        desc: 'List of specialists responsible for primary examination, triage, and initial medical care of patients admitted to the center.',
        empty: 'No data yet.',
    },
};
...
export default function DeptAdmission() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getQabul(); // DRF paginated object bo‘lishi mumkin
