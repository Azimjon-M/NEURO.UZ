...
const UI_T = {
    uz: {
        ...
        desc: 'Bosh miya, orqa miya va asab tizimi shikastlanishlari, shoshilinch neyroxirurgik holatlar hamda KKT oqibatlarini davolash bilan shug‘ullanuvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Отделение экстренной нейрохирургии и последствий ЧМТ',
        desc: 'Список специалистов по лечению острых нейрохирургических состояний и последствий черепно-мозговых травм.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Emergency Neurosurgery and TBI Sequelae Department',
        desc: 'List of specialists in emergency neurosurgical care and treatment of traumatic brain and spinal injuries.',
        empty: 'No data yet.',
    },
};
...
export default function DeptEmergencyTrauma() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getFavqulotdaNeyroxirurgiyaKKT(); // DRF paginated object bo‘lishi mumkin
