...
const UI_T = {
    uz: {
        ...
        desc: "Bosh miyya asosi (skull base) o'smalari va murakkab patologiyalarni diagnostika hamda jarrohlik davolash bilan shug'ullanuvchi mutaxassislar ro'yxati.",
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Отделение нейрохирургии основания черепа',
        desc: 'Список специалистов по диагностике и хирургическому лечению опухолей и сложных патологий основания черепа.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Skull Base Neurosurgery Department',
        desc: 'List of specialists in diagnosis and surgical management of skull base tumors and complex pathologies.',
        empty: 'No data yet.',
    },
};
...
export default function DeptSkullBase() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getBoshMiyyaAsosiNeyroxirurgiyasi(); // DRF paginated object bo‘lishi mumkin
