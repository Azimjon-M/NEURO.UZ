...
const UI_T = {
    uz: {
        ...
        desc: 'Yangi tug‘ilgan chaqaloqlardan tortib o‘smirlarigacha bo‘lgan yosh bemorlarda tug‘ma va orttirilgan neyroxirurgik kasalliklarni aniqlash va davolash bilan shug‘ullanuvchi mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Отделение детской нейрохирургии',
        desc: 'Список специалистов, занимающихся диагностикой и лечением врождённых и приобретённых нейрохирургических заболеваний у детей и подростков.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Pediatric Neurosurgery Department',
        desc: 'List of specialists in diagnosing and treating congenital and acquired neurosurgical conditions in infants, children, and adolescents.',
        empty: 'No data yet.',
    },
};
...
export default function DeptPediatric() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getBolalarNeyroxirurgiyasi(); // DRF paginated object bo‘lishi mumkin
