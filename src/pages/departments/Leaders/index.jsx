...
const UI_T = {
    uz: {
        title: 'Rahbarlar',
        desc: 'Markaz bo‘limlari rahbarlari va bosh mutaxassislar ro‘yxati.',
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Руководители отделов',
        desc: 'Список руководителей и ведущих специалистов центров.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Department Leaders',
        desc: 'List of department heads and senior specialists.',
        empty: 'No data yet.',
    },
};
...
export default function DeptLeaders() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getRahbar(); // DRF paginated object bo‘lishi mumkin
