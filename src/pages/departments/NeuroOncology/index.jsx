...
const UI_T = {
    uz: {
        ...
        desc: "Markazning neyro-onkologik kasalliklarni aniqlash va jarrohlik hamda kompleks davolashga ixtisoslashgan mutaxassislari ro'yxati.",
        empty: "Hozircha ma'lumot yo‘q.",
    },
    ru: {
        title: 'Отделение нейроонкологии',
        desc: 'Список специалистов, занимающихся диагностикой и комплексным лечением нейроонкологических заболеваний.',
        empty: 'Пока нет данных.',
    },
    en: {
        title: 'Neuro-oncology Department',
        desc: 'List of specialists in diagnosis and comprehensive treatment of neuro-oncological diseases.',
        empty: 'No data yet.',
    },
};
...
export default function DeptNeuroOncology() {
    ...
    const getData = useCallback(async () => {
        try {
            const res = await ApiResult.getNeyroOnkologiya(); // DRF paginated object bo‘lishi mumkin
