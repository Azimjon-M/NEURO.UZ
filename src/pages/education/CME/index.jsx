...
const UI_T = {
    uz: {
        ...
        fallbackTitle: 'Malaka oshirish kurslari',
        fallbackDesc:
            'Malaka oshirish kurslari bo‘limida qabul shartlari, o‘quv dasturlari, sertifikatlash va tegishli hujjatlar bilan tanishing.',
    },
    ru: {
        openFile: 'Открыть файл',
        openAttachment: 'Открыть вложение',
        empty: 'Данные не загружены',
        fallbackTitle: 'Курсы повышения квалификации',
        fallbackDesc:
            'Узнайте об условиях приёма, учебных программах, сертификации и связанных документах.',
    },
    en: {
        openFile: 'Open file',
        openAttachment: 'Open attachment',
        empty: 'No data loaded',
        fallbackTitle: 'Continuing Medical Education',
        fallbackDesc:
            'Learn about admission requirements, curricula, certification, and related documents.',
    },
};
...
const CME = () => {
    ...
    const getData = useCallback(async () => {
        try {
            const response = await ApiResult.getMalakaOshirishKurslari();
