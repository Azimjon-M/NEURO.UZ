// src/pages/education/EduCollab.jsx
...
const UI_T = {
    uz: {
        ...
        fallbackTitle: 'Ilmiy hamkorlik',
        fallbackDesc:
            'Markazning xalqaro va mahalliy tashkilotlar bilan ilmiy hamkorlik yo‘nalishlari, qo‘shma loyihalar va hujjatlar bilan tanishing.',
    },
    ru: {
        openFile: 'Открыть файл',
        openAttachment: 'Открыть вложение',
        empty: 'Данные не загружены',
        fallbackTitle: 'Научное сотрудничество',
        fallbackDesc:
            'Узнайте о направлениях научного сотрудничества центра с международными и местными организациями, совместных проектах и документах.',
    },
    en: {
        openFile: 'Open file',
        openAttachment: 'Open attachment',
        empty: 'No data loaded',
        fallbackTitle: 'Research Collaboration',
        fallbackDesc:
            'Explore the center’s collaborations with local and international organizations, joint projects, and related documents.',
    },
};
...
const EduCollab = () => {
    ...
    const getData = useCallback(async () => {
        try {
            const response = await ApiResult.getIlmiyHamkorlik();
