// src/pages/education/EduPatents.jsx
...
const UI_T = {
    uz: {
        ...
        fallbackTitle: 'Patentlar',
        fallbackDesc:
            'Markaz olimlari tomonidan olingan patentlar, mualliflik guvohnomalari va tegishli hujjatlar bilan tanishing.',
    },
    ru: {
        openFile: 'Открыть файл',
        openAttachment: 'Открыть вложение',
        empty: 'Данные не загружены',
        fallbackTitle: 'Патенты',
        fallbackDesc:
            'Ознакомьтесь с патентами и авторскими свидетельствами сотрудников центра, а также связанными документами.',
    },
    en: {
        openFile: 'Open file',
        openAttachment: 'Open attachment',
        empty: 'No data loaded',
        fallbackTitle: 'Patents',
        fallbackDesc:
            'Explore patents and authorship certificates by the center’s researchers and related documents.',
    },
};
...
const EduPatents = () => {
    ...
    const getData = useCallback(async () => {
        try {
            const response = await ApiResult.getPatentlar();
